...
namespace App\Filament\Resources\CajaChicaResource\Pages;

use App\Filament\Resources\CajaChicaResource;
...
class ListCajaChica extends ListRecords
{
    ...
    protected function getHeaderActions(): array
    {
        ...
        $registrar = function (array $data, string $tipo): void {
            $idCaja = $this->cajaChicaId();

            if (! $idCaja) {
                Notification::make()->danger()
                    ->title('Sin caja chica')
                    ->body('No hay una caja chica activa para esta sucursal.')
                    ->send();
                return;
            }
