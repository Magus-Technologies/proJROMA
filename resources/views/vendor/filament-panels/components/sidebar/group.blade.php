...
>
    ...
    @if ($hasDropdown)
        {{--
            Copia de filament-panels::components.sidebar.group con un solo
            cambio: teleport.

            Con la barra plegada, los submódulos salen en un desplegable que
            Filament dibuja dentro de la propia barra. Nuestra barra recorta lo
            que se sale (overflow hidden, y la lista tiene scroll propio), así
            que el desplegable aparecía cortado y por debajo del contenido.
            Con teleport el panel se cuelga del <body> y ya nada lo recorta.
            Al subir Filament, revisar si el original cambió.
        --}}
        <x-filament::dropdown
